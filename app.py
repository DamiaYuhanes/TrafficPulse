    ...
    if start_btn:
        ...
        while cap.isOpened() and not stop_btn:
            ...
            if class_frame_counts:
                ...
                class_chart.plotly_chart(fig_pie, use_container_width=True, key=f"pie_{frame_count}")
            ...
            if frame_count % 5 == 0:
                ...
                timeline_chart.plotly_chart(fig_line, use_container_width=True, key=f"timeline_{frame_count}")
                ...
                if counter.counts:
                    ...
                    crossing_chart.plotly_chart(fig_bar, use_container_width=True, key=f"crossing_{frame_count}")
